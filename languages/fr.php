...
Vous pouvez le consulter ici : %s',
  ...
  'tag_tools:js:autocomplete:required' => 'Merci de renseigner les tags,',
  'admin:upgrades:set_tag_notifications_sent' => 'Tag tools - marquer tous les tags comme envoyé',
  'admin:tags' => 'Tags',
  ...
  'tag_tools:rules:edit' => 'Éditer la règle de tag',
  ...
  'admin:upgrades:set_tag_notifications_sent:description' => 'Marquer tous les tags sur le contenus suivis comme envoyé. Utile dans le cas d\'une montée de version du plugin, ou d\'un nouveau plugin',
);
