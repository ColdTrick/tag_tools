...
if (tag_tools_is_user_following_tag($encoded_tag)) {
	system_message(elgg_echo('tag_tools:actions:follow_tag:success:follow', [$encoded_tag]));
} else {
	system_message(elgg_echo('tag_tools:actions:follow_tag:success:unfollow', [$encoded_tag]));
}
